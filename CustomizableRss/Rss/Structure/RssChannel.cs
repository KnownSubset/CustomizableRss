...
namespace CustomizableRss.Rss.Structure
{
    ...
    public class RssChannel
    {
        ...
        {
            get { return new CultureInfo(InternalLanguage); }
        ...
        {
            get { return new RssDate(InternalLastBuildDate).Date; }

            set { InternalLastBuildDate = new RssDate(value).DateString; }
        }
        ...
        {
            get { return new RssDate(InternalPubDate).Date; }

            set { InternalPubDate = new RssDate(value).DateString; }
        }
        ...
        public int TTL
        {
            get { return new RssTtl(InternalTTL).TTL; }
